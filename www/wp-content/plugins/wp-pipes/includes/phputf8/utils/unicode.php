<?php
/**
 * @version    $Id: unicode.php 23 2014-01-11 08:24:20Z thongta $
				...
				if ( $arr[$k] == 0xFEFF ) {
					...
					if ( $arr[$k] >= 0xD800 && $arr[$k] <= 0xDFFF ) {
						...
						if ( $arr[$k] <= 0xffff ) {
							...
							_e(chr( 0xe0 | ( $arr[$k] >> 12 ) ));
							_e(chr( 0x80 | ( ( $arr[$k] >> 6 ) & 0x003f ) ));
							_e(chr( 0x80 | ( $arr[$k] & 0x003f ) ));
							...
							if ( $arr[$k] <= 0x10ffff ) {
								...
								_e(chr( 0xf0 | ( $arr[$k] >> 18 ) ));
								_e(chr( 0x80 | ( ( $arr[$k] >> 12 ) & 0x3f ) ));
								_e(chr( 0x80 | ( ( $arr[$k] >> 6 ) & 0x3f ) ));
								_e(chr( 0x80 | ( $arr[$k] & 0x3f ) ));
